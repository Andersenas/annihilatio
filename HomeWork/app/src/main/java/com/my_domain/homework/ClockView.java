...
public class ClockView extends View {
    ...
    private int handTuncation, hourHandTuncation = 0;
    ...
    private void initClock(){
        ...
        handTuncation = min / 20;
        hourHandTuncation = min / 7;
        paint = new Paint();
        isInit = true;
    }
    ...
    private void drawHands(Canvas canvas, double loc, boolean isHour) {
        ...
        int handRadius = isHour ? radius - handTuncation - hourHandTuncation : radius - handTuncation;
