...
public class PersonDBHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_PERSON_COUNTRY = "country";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(" CREATE TABLE " + TABLE_NAME + " (" +
                ...
                COLUMN_PERSON_COUNTRY + " TEXT NOT NULL, " +
    ...
    public void saveNewPerson(Person person) {
        ...
        values.put(COLUMN_PERSON_COUNTRY, person.getCountry());
    ...
    public List<Person> peopleList(String filter) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                person.setCountry(cursor.getString(cursor.getColumnIndex(COLUMN_PERSON_COUNTRY)));
    ...
    public Person getPerson(long id){
        ...
        if(cursor.getCount() > 0) {
            ...
            receivedPerson.setCountry(cursor.getString(cursor.getColumnIndex(COLUMN_PERSON_COUNTRY)));
    ...
    public void updatePersonRecord(long personId, Context context, Person updatedperson) {
        ...
        db.execSQL("UPDATE  "+TABLE_NAME+" SET name ='"+ updatedperson.getName() + "', age ='" + updatedperson.getAge()+ "', country ='"+ updatedperson.getCountry() + "', image ='"+ updatedperson.getImage() + "'  WHERE _id='" + personId + "'");
